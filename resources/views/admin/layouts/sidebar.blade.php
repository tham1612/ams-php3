                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarLayouts">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{url('admin.catelogues.create')}}" target="_blank" class="nav-link"
                                   data-key="t-detached">Them moi</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url('admin.catelogues.index')}}" target="_blank" class="nav-link"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="Prodcuts">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{url('admin.products.create')}}" target="_blank" class="nav-link"
                                   data-key="t-detached">Them moi</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url('admin.products.index')}}" target="_blank" class="nav-link"
                                   data-key="t-two-column">Danh sach</a>
                            </li>
